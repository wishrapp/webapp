...
CREATE POLICY "profiles_select_225725"
ON profiles FOR SELECT
USING (true);

CREATE POLICY "profiles_insert_225725"
...
CREATE POLICY "profiles_update_225725"
ON profiles FOR UPDATE
USING (auth.uid() = id)
WITH CHECK (auth.uid() = id);

CREATE POLICY "profiles_delete_225725"
ON profiles FOR DELETE
USING (auth.uid() = id);

CREATE POLICY "profiles_admin_225725"
ON profiles
USING (is_admin());
