/*
  ...
  1. Changes
    ...
    - Add policies
    - Add indexes
    - Add trigger for default occasions
...
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'occasions') THEN
...
-- Recreate function to add default occasions
